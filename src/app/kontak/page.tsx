      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-20">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            <div className="flex flex-col gap-4 p-8 bg-white border border-border-premium/50 rounded-[2px] shadow-premium">
              <div className="flex gap-4">
                ...
                <div className="flex flex-col gap-1 text-xs text-neutral-muted leading-relaxed">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex flex-col gap-1 text-xs text-neutral-muted leading-relaxed">
                  ...
                  <p className="text-[11px] italic pt-1 text-neutral-muted leading-relaxed">
          ...
          <div className="lg:col-span-5 bg-white border border-border-premium/50 rounded-[2px] p-8 shadow-premium flex flex-col gap-6">
            <h3 className="text-xs uppercase tracking-luxury font-semibold text-primary">Tanya Tim Spesialis</h3>
            
            <div className="flex flex-col gap-4">
              <div className="flex justify-between items-center text-xs border-b border-border-premium/20 pb-4">
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 border border-accent/25 hover:bg-accent text-accent hover:text-primary-dark text-[10px] font-semibold uppercase tracking-luxury px-5 py-2.5 rounded-[2px] transition-colors cursor-pointer"
                >
                  <Phone size={11} />
        ...
        <section className="bg-white border border-border-premium/50 rounded-[2px] p-8 sm:p-12 shadow-premium text-left">
          <header className="max-w-2xl flex flex-col gap-3 mb-10">
            <span className="text-[10px] font-semibold uppercase tracking-luxury text-accent">Formulir Konsultasi Awal</span>
