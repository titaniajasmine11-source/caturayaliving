          ...
          {categories.map((category) => {
            ...
            return (
              <button
                ...
                className={`px-5 py-2.5 rounded-[2px] text-[10px] font-semibold uppercase tracking-luxury transition-all focus:outline-none cursor-pointer ${
                  isActive 
            ...
            {filteredPortfolio.map((item, index) => (
              ...
              >
                <div className="h-[240px] relative w-full overflow-hidden bg-accent-light/10">
                  ...
                  <div className="absolute bottom-4 right-4 bg-primary/85 backdrop-blur text-white text-[9px] font-semibold px-2.5 py-1 rounded-[2px] border border-white/5">
                ...
                <div className="p-8 flex flex-col gap-4 flex-1 justify-between">
                  <div className="flex flex-col gap-2.5">
                    ...
                    <div className="text-[10px] text-neutral-muted bg-accent-light/50 border border-border-premium/25 px-3.5 py-2.5 rounded-[2px] mt-2 flex items-center gap-1.5 font-medium">
